...
server <- function(input, output, session) {
  ...
  output$country_note <- renderUI({
    ...
    HTML(sprintf(
      "<span style='font-size:1px; color:#444; margin-left:40px; display: block;'><b>Note:</b> Countries under 1,000 sq miles (including Hong Kong and Mauritius) are not visible on this map.<br>
